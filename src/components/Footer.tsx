...
const Footer = () => {
  ...
  return (
    <footer className="md:h-screen container flex flex-col justify-around pb-20 md:pb-0">
      <div className="flex max-md:flex-col justify-between items-center">
        <div className="flex flex-col md:w-1/3 max-md:items-center max-md:mb-4">
          ...
          <p className="text-md text-gray-600 max-md:text-center">
            ...
            doloribus et deleniti numquam eos, laboriosam repellat veritatis
            minima, nam voluptates eveniet! Excepturi blanditiis obcaecati
            animi.
          </p>
        </div>
        <div className="flex gap-4 md:gap-2 max-md:w-full justify-between md:justify-end text-xs md:text-base mb-3">
          <Button onClick={handleSignIn} variant="outline">
            Buat Akun
          </Button>
          <Button className="flex items-center gap-2 justify-center bg-green-500 hover:bg-green-700">
      ...
      <div className="flex justify-between max-md:flex-col max-md:mt-5">
        <div className="md:w-1/3 flex flex-col">
          ...
          <p className="text-md text-gray-600 mb-4 max-md:text-center">
            ...
            nisi odio quo officia consequuntur voluptatum culpa atque vitae
            sequi? Fuga dignissimos maxime odio reprehenderit eius.
          </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            {FooterList3.map((item) => (
              <Link
                key={item.title}
                href={item.path}
                className="text-sm md:text-md text-gray-600 hover:text-primary flex items-center gap-2 max-md:justify-center">
                {item.title}
                <ArrowBigLeftDash />
              </Link>
            ))}
